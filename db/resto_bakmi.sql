...
MySQL - 10.1.21-MariaDB : Database - resto_new
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`resto_new` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `branches`(`branch_id`,`branch_name`,`branch_img`,`branch_desc`,`branch_address`,`branch_phone`,`branch_city`) values (3,'Bakmi Gili 1','1487748757_logo.png','','Delta Mall','0315926983','Surabaya'),(4,'Bakmi Gili 2','1487748767_logo.png','Cabang Baru Balkpapan','Tunjungan Plaza','08123120398','Surabaya');
...
insert  into `journals`(`journal_id`,`journal_type_id`,`data_id`,`data_url`,`journal_debit`,`journal_credit`,`journal_piutang`,`journal_hutang`,`journal_date`,`journal_desc`,`bank_id`,`user_id`,`branch_id`) values (1,1,2,'',24000,0,0,0,'2017-02-28','Meja Meja 4',0,11,3);
...
insert  into `reserved`(`reserved_id`,`table_id`,`name`,`phone`,`address`,`amount`,`date`,`status`) values (2,51,'Fitria','0315484702','Simo Sido Mulyo 5 No. 22',4,'2017-02-24 21:00:00',0);
...
insert  into `widget_tmp`(`wt_id`,`user_id`,`menu_id`,`jumlah`,`table_id`,`wt_desc`,`printed`) values (6,11,2,1,43,'',0),(7,11,6,1,30,'',0),(11,39,346,1,47,'',0),(23,11,548,1,51,'',0),(25,11,547,1,0,'asdasdasd',0);
...
insert  into `widget_tmp_details`(`wtd_id`,`wt_id`,`note_id`) values (12,23,1),(13,23,6),(14,23,11),(15,23,15),(16,23,21),(18,25,1),(19,25,8),(20,25,13),(21,25,15),(22,25,19);

/* Trigger structure for table `transactions` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `transactions_insert` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `transactions_insert` AFTER INSERT ON `transactions` FOR EACH ROW BEGIN
  INSERT INTO resto_admin.transactions (
				transaction_id,
				table_id,
				branch_id,
				member_id,
...
VALUES (NEW.transaction_id,
				...
				NEW.transaction_discount,
				NEW.disc_member,
				NEW.transaction_grand_total,
				NEW.transaction_payment,
				NEW.transaction_change,
				NEW.transaction_disc_nominal,
