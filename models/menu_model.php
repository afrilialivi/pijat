<?php
	...
	function select(){
		$query = mysql_query("SELECT a.* , b.kategori_utama_name, c.menu_type_name, d.partner_name
													FROM menus a
													JOIN kategori_utama b ON b.id_kategori_utama = a.menu_kategori
													JOIN menu_types c ON c.menu_type_id = a.menu_type_id
													JOIN partners d ON d.partner_id = a.partner_id
													ORDER BY menu_id");
		return $query;
	}
