...
function select_note(){
        $query = mysql_query("SELECT a. note_id, a.note_name, b.note_category_name
                                                FROM notes a
                                                JOIN note_categories b ON a.note_category_id = b.note_category_id");
        return $query;
}
...
function select_history($table_id){
 ...
 // function get_transactions_detail_status($i_table_id){
 //  $transaction_id = mysql_query("select transaction_id from transactions_tmp where = '.$table_id.' ");
 //  $query = mysql_query("select * from transactions_tmp_details where = '.$transaction_id.'");
 //  return $row['transaction_detail_status'];
 // }
...
function get_transaction_id_old($table_id, $i_tot_id, $i_member_id){
	...
	mysql_query("update transactions_tmp set tot_id = '".$i_tot_id."'
							  where table_id = '".$table_id."'
							  ");
	mysql_query("update transactions_tmp set member_id = '".$i_member_id."'
								where table_id = '".$table_id."'
								");
	$row = mysql_fetch_array($query);
...
function get_transactions_detail_status_old($transaction_id){
	$query = mysql_query("select transaction_detail_status
...
function get_jml_orang($id){
	$query = mysql_query("SELECT jml_orang as  result FROM transactions_tmp WHERE table_id = '$id'");
	$row = mysql_fetch_array($query);
	return $row['result'];
}
