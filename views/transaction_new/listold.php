												...
												<div class="col-md-3" style="padding-left: 0px;">
													<div class="form-group">
														...
														<div class="input-group">
															...
															<input type="text" required class="form-control pull-right" id="date_picker4" name="i_date" value="<?= $date ?>"/>
														</div><!-- /.input group -->
													</div>
												</div>
												<div class="col-md-3" style="padding-left: 0px;">
   ...
   <script type="text/javascript">
	 		function dialogModal(x){
				...
				$('.dialog_content').dialogModal({
					...
					onLoad: function() {
						$(".dialogModal_content").load('transaction_new.php?page=popmodal&menu_id='+x+'&type='+a+'&member_id='+b);
					},
					onClose: function() {},
				});
			}
